...
describe('CsvReport', () => {
    ...
    it('should write CSV report with correct headers and data', async () => {
        ...
        expect(csvWriterInstanceStub.writeRecords.calledTwice).to.be.true;
        ...
        expect(csvWriterInstanceStub.writeRecords.secondCall.args[0]).to.deep.equal([
    ...
    it('should handle empty metadata gracefully', async () => {
        ...
        expect(csvWriterInstanceStub.writeRecords.notCalled).to.be.true; // But no records are written
    });
});
